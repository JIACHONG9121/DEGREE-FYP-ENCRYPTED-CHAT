...
<body>
    ...
    <div class="register-container">
        <section class="formReg">
            ...
            <form class="register-form" action="BackEnd/addUBE.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="input">
                ...
                <div class="input">
                    <label class="text">Intake Code</label>
                    <input type="text" name="Intakecode" placeholder="Intake code" required>
                </div>
