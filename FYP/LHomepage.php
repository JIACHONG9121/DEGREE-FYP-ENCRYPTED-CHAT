...
<body>
  <div class="include">
    <?php
    $sql = mysqli_query($conn, "SELECT * FROM lecturer WHERE unique_id = '{$_SESSION['unique_id']}'");
  ...
  <div class="news-and-holidays-container">
    <div class="news-container">
      ...
      <h2>Latest News</h2>
      <!-- Add news articles, content, or any other elements here -->
